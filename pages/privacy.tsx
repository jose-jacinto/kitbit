...
export default function Payments() {
    ...
    return (
        <Container>
            ...
            Effective Date: This Privacy Policy was last revised on March 2021

            Introduction and Overview

            You have arrived at a web site that is provided by Cottonhat Software Unipessoal LDA and / or its affiliates(Cottonhat, Kitbit or “we, ” “our” or “us”).This “Privacy Policy” governs your use of kitbit.eu and any other official Kitbit sites(including mobile sites or apps), and any interactive features, applications, and / or other services that we make available through a site that posts a link to this Privacy Policy(collectively, referred to as the “Site”).This Privacy Policy also applies to Personal Information(defined below) we may collect from you in our Kitbit retail stores(“Store” or “Stores”), and through official surveys and sweepstakes entry forms, or in any other instance when you contact us or interact with us.

            This Privacy Policy describes what information Kitbit collects about you, why we collect it, how we use it, and under what circumstances we share it with third parties.This Privacy Policy also describes the choices you can make about how we use your information.To the extent we provide you notice on our Site or in our Stores of different or additional privacy policies or practices(e.g., at the point of our collection), those additional terms shall govern such data collection and use.

            Table of Contents

            It is important that you read and understand the entire Privacy Policy before using the Site.To ease review, each section below contains a brief introductory summary and a link to the full explanation.You can click on the headings and the “More” buttons to be taken to the full explanation.Should you wish to print out this Privacy Policy, you may do so via the “print” feature of your web browser.
            ...
            Third Parties Providing Services to Kitbit
            Adobe Marketing Cloud Device Co - op
            To Protect the Rights of Kitbit and our Users
            ...
            1. Collection of Information: We collect the following categories and types of information from the various sources highlighted below:
            2. Information You Provide to Us
            In this Policy “Personal information” means information that identifies, relates to, describes, is capable of being associated with, or could reasonably be linked, directly or indirectly, with a particular consumer or household.This will usually include various different types of information as describe below.

            We may ask you to provide us with the following Personal Information: (1) contact information and other identifying information, including your first and last name, email address, home address, zip code, phone number; (2) financial information, including credit and debit card numbers, checking account numbers; (3) demographic information, including date of birth; (4) audio and visual information, including your videos and photos; (5) commercial information, including products purchased or viewed on our Site; and(6) inferences drawn from the other information that we receive directly or passively from you, in order to create a profile about you to reflect your preferences, characteristics, behavior and attitude.We may collect this information from you such as when you:
...
1. Information We Passively Collect When You Use the Site
In addition to information that you choose to submit to us, we and / or our service providers may automatically collect and / or store certain identifiable information when you visit or interact with the Site(“Usage Information”).This Usage Information may be stored and / or accessed from your personal computer, laptop, tablet, mobile phone or other device(a “Device”) whenever you visit or interact with our Site.Usage Information may include:
...
- your general location; and certain other Device data, including the time of day you visit our Site, among other information.
...
- To offer you enhanced functionality when accessing the Site, including identifying you when you signin to our Site or keeping track of your specified preferences.
...
1. Information We Collect When You Interact with Third - Party Sites
...
- Sending you email about orders you have made on Kitbit.com;
...
1. Third Parties Providing Services to Kitbit.
We may use third party service providers to perform certain services, such as: (a) to assist us in e - commerce operations; (b) to manage a database of customer information; (c) hosting the Site; (d) designing and / or operating the Site’s features; (e) tracking the Site’s activities and analytics; (f) enabling us to send you special offers or perform other administrative services; (g) to allow you to participate in live chat on the Site; and(h) other services designed to assist us in maximizing our business potential.We may provide third parties with access to your information to carry out the services they are performing for us.We only provide our Service Providers with the information necessary for them to perform these services on our behalf.Each Service Provider must agree to use reasonable security procedures and practices, appropriate to the nature of the information involved, in order to protect your Personal Information from unauthorized access, use, or disclosure.Service Providers are prohibited from using Personal Information other than as specified by us.Third - party analytics and other service providers such as Google Analytics may set and access their own technologies on your Device and they may otherwise collect or have access to information about you.These service providers use the technology described above to help us analyze how users use the Site and to provide advertisements to you on other websites.We are not responsible for those third party technologies or activities arising out of them.However, some third parties may offer you certain choices regarding their practices.For example, to learn about opting out of Google Analytics, please click here.To learn about opting out of the use of Adobe cookies for analytics and on - site personalization, please click here.We are not responsible for the effectiveness of or compliance with any third parties’ opt - out options.

To Protect the Rights of Kitbit and our Users.
We may disclose your Personal Information if we believe in good faith that doing so is necessary or appropriate to: (i) protect or defend the rights, safety or property of Kitbit or third parties(including through the enforcement of this Policy, our Terms of Use, and other applicable agreements and policies); or(ii) comply with legal and regulatory obligations(e.g., pursuant to law enforcement inquiries, subpoenas or court orders).
...
The Site may contain content that is supplied by a third party, and those third parties may collect Usage Information and your Device Identifier when pages from the Site are served to you.In addition, when you are on the Site, you may be directed to other services that are operated and controlled by third parties.For example, the giftcertificates.com site used to purchase Kitbit gift cards online is operated by a third party.We are not responsible for the data collection and privacy practices employed by any of these third parties.You access these third party websites or content at your own risk.For example, if you “click” on a link, the “click” may take you off the Site onto a different site.These other sites may independently collect data about you and may or may not have their own published privacy policies.
...
If you have any questions about the Privacy Policy, or practices described in it, please direct your communication to the above address “Attn: Privacy Officer / Legal Department.” You may also send an email to privacy@kitbit.eu.
...
Applicable Law
The Privacy Policy will be governed by and construed in accordance with the laws of Portugal.
...
We Not Sell Personal Information


©2021 Kitbit.All Rights Reserved.
